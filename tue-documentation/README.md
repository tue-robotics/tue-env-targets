...
## Python
Python documentation is generated by [Sphinx](http://sphinx-doc.org/). A fully dynamic Sphinx configuration is available: [config](https://github.com/irohms-robotics/tue_documentation_python.git). Add this to your package as a submodule,
```bash
git submodule add https://github.com/irohms-robotics/tue_documentation_python.git FOLDER -b master
```

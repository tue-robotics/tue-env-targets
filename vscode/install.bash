...
# Configure workspace
workspacefile="${IROHMS_SYSTEM_DIR}/.vscode/settings.json"
...
if ! catkin config --workspace "$IROHMS_SYSTEM_DIR" | grep -q "DCMAKE_EXPORT_COMPILE_COMMANDS"
then
    catkin config --workspace "$IROHMS_SYSTEM_DIR" --append-args -DCMAKE_EXPORT_COMPILE_COMMANDS=ON
fi

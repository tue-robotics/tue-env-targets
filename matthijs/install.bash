...
# Git Settings
git_config_items="advice.skippedCherryPicks=false rebase.autoStash=true color.ui=always merge.tool=meld pull.ff=true url.ssh://git@github.com/.insteadOf=https://github.com/"
